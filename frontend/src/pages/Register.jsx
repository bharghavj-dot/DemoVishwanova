        ...
        <div className="w-full max-w-lg animate-fade-in">
          <div className="card-static p-8 md:p-10">
              ...
              <div className="grid grid-cols-3 gap-3 mb-6">
                {roleOptions.map((r) => (
                  ...
                  >
                    ...
                    <p className={`text-xs font-semibold ${role === r.value ? 'text-primary-500' : 'text-clinical-muted'}`}>
                      {r.label}
                    </p>
                  </button>
                ))}
            ...
            <form onSubmit={handleRegister} className="space-y-5">
              ...
              <label className="flex items-start gap-3 text-sm text-clinical-muted cursor-pointer">
                <input type="checkbox" checked={agreed} onChange={(e) => setAgreed(e.target.checked)} className="mt-1 rounded border-clinical-border text-primary-500 focus:ring-primary-300" />
                <span>I agree to the <span className="text-primary-500 font-medium">Clinical Terms of Service</span> and <span className="text-primary-500 font-medium">Privacy Protocol</span>.</span>
              </label>
            ...
            <div className="text-center mt-6">
              <p className="text-sm text-clinical-muted">Already have an account? <Link to="/login" className="text-primary-500 font-bold hover:underline">Sign In</Link></p>
            </div>
          </div>
